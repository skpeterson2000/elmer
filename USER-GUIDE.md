...
- **Learn** is the Koch method: a lesson slider from two characters to forty, the lesson's characters drawn as shapes to compare against, and two ways to work through them. Below them is a grid of where you stand, green for copied reliably, amber for shaky, red for needs work, grey for not met yet. Hover a character for what it was confused with, and how often it had to be sent again.
  ...
  **Learn them one at a time** is the place to start, and there is no clock on it. One character sounds and then nothing happens at all. Compare what you heard against the shapes above, click any of them to hear it again, ask for the one you are on **Again** as often as you like, and press **I have it** when you have it. Only then is it named: the letter appears, the phonetic word appears beside it, Kilo for K, and it is said aloud. Then the next one sounds and waits in its turn. Nothing here is timed and nothing is scored, because telling two sounds apart is a different skill from copying at speed, and everybody takes a different length of time over it.
