...
### A session is three minutes, and a day is five of them
...
Five passes is what a day comes to, not a quota to be met before a clock runs out. Somebody who got three of them in before the evening went sideways has done three passes of a five-pass set, and the honest thing the next morning is to offer them the last two rather than wipe it and start again - which would be the program punishing them for having a life. The whole argument for this shape is that it fits into the gaps in a day, and a version of it that only works on a clear day is not the same claim.
