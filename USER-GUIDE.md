...
- **Too much club**: only a long club - the driver, the woods, the 4- and 5-iron - swung at well under three quarters of itself. The patch turns amber, dashed and wider, *Dr · too much club*, because that is a swing nobody practises and it scatters, up to two and a half times as wide. The shot really does scatter that much - the patch is the same figure the swing uses.
