...
- **The announcement.** ELMER keys its own name at twenty words a minute on 1020 Hz, once when you open the program rather than once a page. If you are a supporter who asked to be named, your callsign goes out with it: `ELMER DE KC9SP`. The room hears whose unit this is, and somebody who already knows the program hears an invitation to a game. It is the station identifying itself, and it is a plain way of hearing that the unit is up and the sound works before you go hunting for a volume control. Turn it off where it would not be welcome: a net in progress, a classroom, a field site at night. Being quiet is sometimes what being in a community asks of a station. On a browser that keeps audio silent until a page has been touched, it waits for your first click and goes then.
