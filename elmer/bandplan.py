...
ACTIVITY = {
    ...
    # 10 m, the ARRL plan: CW to 28.070, data to 28.150, CW again to 28.190,
    # beacons 28.190-28.300, phone 28.300-29.300 with the AM window inside it
    # at 29.000-29.200, satellite downlinks, then the FM end - inputs, the
    # simplex calling frequency at 29.600, outputs to the top of the band.
    # Three stretches of this used to be left blank - 28.225-28.300,
    # 29.200-29.300 and 29.680-29.700 - which drew as black holes on the
    # strip and read as privileges missing; they were only rows missing.
    "10 m": [
        (28.000, 28.070, "cw", "CW"),
        (28.060, 28.060, "calling", "CW QRP calling"),
        (28.070, 28.120, "digital", "Digital modes"),
        (28.074, 28.074, "calling", "FT8"),
        (28.120, 28.150, "digital", "Unattended digital"),
        (28.150, 28.190, "cw", "CW"),
        (28.190, 28.300, "beacon", "Beacons"),
        (28.200, 28.200, "beacon", "IBP beacons"),
        (28.300, 28.680, "phone", "SSB"),
        (28.385, 28.385, "calling", "SSB QRP calling"),
        (28.680, 28.680, "image", "SSTV"),
        (28.680, 29.300, "phone", "SSB"),
        ...
        (29.610, 29.700, "repeater", "FM repeater outputs"),
    ],
    "6 m": [
        ...
        (50.800, 51.000, "special", "Radio control"),
    ...
    "70 cm": [
        ...
        (433.000, 435.000, "special", "Auxiliary and repeater links"),
        ...
        (445.000, 446.000, "repeater", "Repeaters, links and simplex"),
    ...
    "33 cm": [
        ...
        (915.000, 918.000, "digital", "Digital, mixed modes and links"),
