...
CARDS = [
    ...
    ("James Clerk Maxwell's equations of 1865 predicted electromagnetic waves "
     "traveling at the speed of light - more than twenty years before anyone "
    ...
    ("The Radio Act of 1912, passed months after the Titanic, required every "
     "American radio operator to hold a license. The amateur license you are "
     "studying for descends from it.", "the license, 1912"),
    ...
    ("The first two-way amateur contact across the Atlantic was made in "
     ...
     "Connecticut and Leon Deloy 8AB in Nice, on about 110 meters.",
    ...
    # --- the bands, and the license -----------------------------------------
    ("The Radio Act of 1912 sent amateurs to wavelengths of 200 meters and "
    ...
    ("The 1927 Washington radiotelegraph conference gave amateurs the bands "
     "near 80, 40, 20 and 10 meters - harmonically related on purpose, so a "
     "transmitter's harmonics fell in another amateur band rather than on "
     "somebody else.", "the harmonic bands, 1927"),
    ("The 30, 17 and 12 meter bands came from the World Administrative Radio "
    ...
    ("The Morse code test was dropped from every US amateur license on 23 "
    ...
    ("OSCAR 3, launched in March 1965, carried the first amateur transponder "
     "- a linear translator on 2 meters - and relayed about a thousand "
     "contacts in its eighteen days.", "OSCAR 3, 1965"),
    ("Owen Garriott, W5LFL, made the first amateur radio contacts from space "
     "in December 1983, on 2 meters FM from the shuttle Columbia. The station "
...
# Hams people have heard of. Callsigns are from the license records or the
...
HAMS = [
    ...
    ("Marlon Brando - FO5GJ (SK)", "Held a French Polynesian license for his atoll, "
    ...
    ("Tim Allen - KK6OTD", "The actor got his license in 2014 while his character "
...
# How the art is practiced - the things an exam never asks and every net
