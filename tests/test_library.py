...
check("  the FT-991A on the shelf ticks HF, VHF and VHF SSB", g["gear"], ["hf_wire", "mobile_vhf", "vhf_ssb"])
...
check("marking only a non-radio book falls back to the shelf", (g["basis"], g["gear"]),
      ("shelf", ["hf_wire", "mobile_vhf", "vhf_ssb"]))
...
check("the route answers the same", (r["basis"], r["gear"]), ("shelf", ["hf_wire", "mobile_vhf", "vhf_ssb"]))
